...
const App: React.FC = () => {
  const [openFileIds, setOpenFileIds] = useState<string[]>(['readme', 'about']);
    ...
    <div className="h-screen flex flex-col select-none transition-all duration-300 font-display overflow-hidden" 
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        <main className="flex-1 flex flex-col min-w-0 bg-editor-bg overflow-hidden">
          ...
          <div className="flex-1 flex flex-col min-h-0">
              ...
              {openFileIds.map(fid => {
                ...
                return (
                  <div
                    ...
                    className={`flex items-center px-4 gap-2 h-full text-xs md:text-sm cursor-pointer border-r border-theme transition-all whitespace-nowrap ${
                  ...
                  >
                    ...
                    <span 
                      ...
                      className="material-icons-outlined text-[10px] ml-2 opacity-30 hover:opacity-100 hover:bg-black/10 p-0.5 rounded"
                    >
                      close
                    </span>
                  </div>
            ...
            {/* Breadcrumbs */}
            {activeFile && (
              <div className="h-7 bg-background-dark px-4 flex items-center gap-1 text-[11px] opacity-40 border-b border-theme flex-shrink-0">
      ...
      <footer className="h-6 bg-primary text-background-dark flex items-center justify-between px-3 text-[11px] font-bold flex-shrink-0 z-20">
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-1 px-2 hover:bg-black/10 cursor-pointer h-full">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-1 px-2 hover:bg-black/10 cursor-pointer h-full" onClick={() => setIsTerminalOpen(!isTerminalOpen)}>
